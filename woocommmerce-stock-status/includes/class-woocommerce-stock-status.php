 ...
 */
class Woocommerce_Stock_Status {
	...
	public function __construct() {
		...
		$this->plugin_name = 'woocommerce-stock-status';
		$this->version = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woocommerce-stock-status-loader.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-woocommerce-stock-status-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-woocommerce-stock-status-public.php';

		$this->loader = new Woocommerce_Stock_Status_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Woocommerce_Stock_Status_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Woocommerce_Stock_Status_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Woocommerce_Stock_Status_Public( $this->get_plugin_name(), $this->get_version() );
