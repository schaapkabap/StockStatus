...
class Woocommerce_Stock_Status_Settings_Tab_code
{
    /**
    ...
    public static function init()
    {
        ...
        add_action('woocommerce_settings_tabs_settings_tab_woocommmerce_stock_status', __CLASS__ . '::settings_tab');
        add_action('woocommerce_update_options_settings_tab_woocommmerce_stock_status', __CLASS__ . '::update_settings');
    }
    /**
    ...
    {
        $settings_tabs['settings_tab_woocommmerce_stock_status'] = __('woocommmerce-stock-status', 'woocommmerce-stock-status-tab');
